...
class FutsalDetailsPageView extends StatefulWidget {
  ...
  const FutsalDetailsPageView({super.key, this.court});
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          CourtTimeSlotSection(
                            ...
                            initialDateIndex: _selectedDateIndexNotifier.value,
                            initialSlotIndex: _selectedSlotIndexNotifier.value,
                            onSelectionChanged: (int dateIndex, int slotIndex) {
                              _selectedDateIndexNotifier.value = dateIndex;
                              _selectedSlotIndexNotifier.value = slotIndex;
                            },
                          ),
