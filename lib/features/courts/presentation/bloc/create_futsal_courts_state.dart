...
class CreateFutsalCourtsState {
  const CreateFutsalCourtsState({
  ...
  factory CreateFutsalCourtsState.initial({
    required String status,
    required int totalSteps,
  }) {
    return CreateFutsalCourtsState(
      currentStep: 0,
  ...
  CreateFutsalCourtsState copyWith({
    int? currentStep,
    int? totalSteps,
    bool? isSlugAuto,
    bool? isSubmitting,
